...
public class SaveManager : MonoBehaviour
{
    ...
    private const string saveFileName = "/Database.ss"; // data.penguin runner files
    ...
    public void Save()
    {
        // If there is n previous state found, create a new one
        if(save == null)
            save = new SaveState();
